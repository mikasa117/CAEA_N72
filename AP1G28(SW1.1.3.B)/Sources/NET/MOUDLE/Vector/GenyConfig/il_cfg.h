...
#define IL_ENABLE_TX_SEND_ON_INIT
...
#define IL_ENABLE_RELOAD_CYCLE_TIMER_ON_TRANSMISSION_REQUEST // Clear Cyclic after the message is sent successfully
...
#if defined(IL_ENABLE_RX) && defined(IL_ENABLE_RX_TIMEOUT)
#define kIlNumberOfRxTimeoutCounters         8
#endif
...
#define kIlCanNumberOfRxObjects              8
