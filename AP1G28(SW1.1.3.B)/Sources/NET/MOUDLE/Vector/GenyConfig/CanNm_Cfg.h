...
#define NM_ASRNMCANDLL_VERSION               0x0331u
...
#define CANNM_COM_CONTROL_EXT_ENABLED STD_OFF
...
#define CANNM_ACTIVE_WUP_BIT_FEATURE_ENABLED STD_ON //The protocol stack cannot be configured.
...
#define CANNM_IMMEDIATE_NM_TX_ON_PASSIVE_START STD_OFF
/* END of Checksum include for
  - CanNmPrecompileCRC */
...
#define CANNM_PRECOMPILE_CRC                 (uint32) 0x561E1DBAu
#define CANNM_LINKTIME_CRC                   (uint32) 0x98D1FE00u
/* CanNm error codes */
