...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             15376
...
/* SvcInst table size. */
#define kDescSvcInstNumItems                                         40
/* SvcInstHeadEx table size. */
#define kDescSvcInstHeadExtNumItems                                  62
/* Context modes */
...
#define kDescSecurityAccessSeedLength                                (vuint8) 4
/* Security access seed maximum length */
#define kDescSecurityAccessMaxSeedLength                             (vuint8) 4
...
#define kDescOemNrcTooManyPIDs                                    kDescNrcInvalidFormat ///  kDescNrcRequestOutOfRange   by ggl
...
static void DESC_API_CALLBACK_TYPE DescOemGetSeedLevel1(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSendKeyLevel1(DescMsgContext* pMsgContext);
...
static vuint8                     g_descSecureNrOfAttempts_NVM;/*ycl 20.5.08*/


vuint8                     g_descSecureNrOfAttempts;
//static vuint16                    g_descSecureTimer;
vuint16                    g_descSecureTimer;     //ggl 2025.0912
...
{
  { { 0x07, 0x02, 0x00 }, { 0x01, 0x01, 0x00 } }, 
  { { 0x06, 0x02, 0x00 }, { 0x02, 0x01, 0x00 } }, 
  { { 0x05, 0x02, 0x00 }, { 0x04, 0x01, 0x00 } }, 
  { { 0x07, 0x02, 0x00 }, { 0x01, 0x01, 0x00 } }, 
  { { 0x07, 0x02, 0x00 }, { 0x01, 0x01, 0x00 } }, 
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSidMap[kDescSvcIdMapSize] = 
{
  ...
  0xFF, 0x0A, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x0B, 0x0C, 0xFF, 
...
V_MEMROM0 static V_MEMROM1 DescSvcHead V_MEMROM2 g_descSvcHead[kDescSvcHeadNumItems] = 
{
  ...
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x07, 0x00,  2,  3,  3 } /* $11 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x05, 0x00,  1,  5,  5 } /* $14 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x05, 0x00,  2,  6,  5 } /* $19 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1, 10,  9 } /* $22 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x07, 0x00,  1, 11,  9 } /* $23 */, 
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 0x00, 0x06, 0x00,  2, 12,  9 } /* $27 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x04, 0x00,  2, 14, 11 } /* $28 */, 

  { 0x07, 2, 2, 0x01, 0x01, 0, 1, 0, 0x00, 0x06, 0x00,  4, 18, 15 } /* $2E */, 
  { 0x0F, 3, 3, 0x01, 0x01, 0, 1, 0, 0x00, 0x04, 0x00,  4, 25, 29 } /* $2F */, 
  { 0x01, 0, 0, 0x01, 0x01, 1, 1, 1, 0x00, 0x06, 0x00,  1, 35, 59 } /* $31 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x07, 0x00,  1, 36, 59 } /* $3D */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x07, 0x00,  2, 37, 59 } /* $3E */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x04, 0x00,  2, 38, 60 } /* $85 */, 
  { 0x00, 0, 0, 0x00, 0x00, 0, 1, 0, 0x00, 0x00, 0x00,  1, 40, 62 } /* $FF */
...
{
  DescDummyPreHandler, 
  ApplDescPreControlDtcSettingEnable, 
  ApplDescPreWriteDidDID_0xF1F6, 
  ApplDescPreIoCtrlShortTermAdjCPID_F1F3
...
{
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 },                      0,    0,    0, DescOemStartSessionDefault } /* $10 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x06, 0x03, 0x00 },                      1,    0,    0, DescOemStartSessionProgramming } /* $10 $2 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 },                      2,    0,    0, DescOemStartSessionExtended } /* $10 $3 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 },                      3,    0,    1, ApplDescEcuResetHard } /* $11 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 },                      4,    0,    2, ApplDescEcuResetSoft } /* $11 $3 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescClearDiagInfo } /* $14 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescReadDtcRNODTCBSM } /* $19 $1 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescReadDtcRDTCBSM } /* $19 $2 */, 

  {   6, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescReadDtcRDTCSSBDTC } /* $19 $4 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescReadDtcRSUPDTC } /* $19 $A */, 
  {   0, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0,    4, DescReadDataByIdentifier } /* $22 */, 
  {   0, { 0x01, 0x01, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescReadMemoryByAddress } /* $23 */, 

  {   2, { 0x01, 0x01, 0 }, { 0x06, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, DescOemGetSeedLevel1 } /* $27 $1 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x06, 0x03, 0x00 },                      5,    0,    0, DescOemSendKeyLevel1 } /* $27 $2 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0,    3, DescOemCommCtrlEnableRxEnableTx } /* $28 $0 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0,    3, DescOemCommCtrlEnableRxDisableTx } /* $28 $1 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0,    3, DescOemCommCtrlDisableRxEnableTx } /* $28 $2 */, 

  {   3, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0,    3, DescOemCommCtrlDisableRxDisableTx } /* $28 $3 */, 
  {  18, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescWriteDidDID_0xF089 } /* $2E $F0 $89 */, 
  {  24, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescWriteDidDID_0xF187 } /* $2E $F1 $87 */, 
  {  16, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    2,    0, ApplDescWriteDidDID_0xF18C } /* $2E $F1 $8C */, 
  {   5, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    2,    0, ApplDescWriteDidDID_0xF1F0 } /* $2E $F1 $F0 */, 
  {  13, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    2,    0, ApplDescWriteDidDID_0xF1F6 } /* $2E $F1 $F6 */, 
  {  93, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescWriteDidDID_0xF1FA } /* $2E $F1 $FA */, 
  {  23, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescWriteDidDID_0xF1FC } /* $2E $F1 $FC */, 

  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlRetCtrlToEcuCPID_F1F1 } /* $2F $F1 $F1 $0 */, 

  {   7, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlShortTermAdjCPID_F1F1 } /* $2F $F1 $F1 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlRetCtrlToEcuCPID_F1F2 } /* $2F $F1 $F2 $0 */, 
  {  13, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlShortTermAdjCPID_F1F2 } /* $2F $F1 $F2 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlRetCtrlToEcuCPID_F1F3 } /* $2F $F1 $F3 $0 */, 
  {  10, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlShortTermAdjCPID_F1F3 } /* $2F $F1 $F3 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlRetCtrlToEcuCPID_F1F4 } /* $2F $F1 $F4 $0 */, 
  {   9, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlShortTermAdjCPID_F1F4 } /* $2F $F1 $F4 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlRetCtrlToEcuCPID_F1F5 } /* $2F $F1 $F5 $0 */, 

  {  10, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    3,    0, ApplDescIoCtrlShortTermAdjCPID_F1F5 } /* $2F $F1 $F5 $3 */, 
  {   0, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0,    0, DescRoutineControlByIdentifier } /* $31 */, 
    {   0, { 0x01, 0x01, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, ApplDescWriteMemoryByAddress } /* $3D */, 

  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0,    0, DescOemProcessTesterPresent } /* $3E $0 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    1,    0, ApplDescControlDtcSettingEnable } /* $85 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    1,    0, ApplDescControlDtcSettingDisable } /* $85 $2 */
};
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSvcInstHeadExt[kDescSvcInstHeadExtNumItems] = 
{
  ...
  0xF0, 0x89, 0xF1, 0x87, 0xF1, 0x8C, 0xF1, 0xF0, 0xF1, 0xF6, 0xF1, 0xFA, 0xF1, 0xFC /* $2E */, 
  0xF1, 0xF1, 0x00, 0xF1, 0xF1, 0x03, 0xF1, 0xF2, 0x00, 0xF1, 0xF2, 0x03, 0xF1, 0xF3, 0x00, 0xF1, 0xF3, 0x03 /* $2F */, 
  0xF1, 0xF4, 0x00, 0xF1, 0xF4, 0x03, 0xF1, 0xF5, 0x00, 0xF1, 0xF5, 0x03 /* $2F */, 
...
{
  { 0xF089,   15, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF089 }, 
  { 0xF120,    4, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF120 }, 
  { 0xF121,    4, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF121 }, 
  { 0xF122,    4, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF122 }, 
  { 0xF170,    4, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF170 }, 
  { 0xF171,    4, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF171 }, 
  { 0xF184,    7, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF184 }, 
  { 0xF187,   21, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF187 }, 
  { 0xF188,   20, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF188 }, 
  { 0xF189,   15, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF189 }, 
  { 0xF18A,    7, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF18A }, 
  { 0xF18C,   13, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF18C }, 
  { 0xF1F0,    2, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1F0 },
  { 0xF1F1,    3, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidCPID_F1F1 }, 
  { 0xF1F2,    9, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidCPID_F1F2 }, 
  { 0xF1F3,    6, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidCPID_F1F3 }, 

  { 0xF1F4,    5, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidCPID_F1F4 }, 
  { 0xF1F5,    6, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidCPID_F1F5 }, 
  { 0xF1F6,   10, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1F6 }, 
  { 0xF1F7,   108, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1F7 }, 
  { 0xF1F8,   12, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1F8 }, 
  { 0xF1F9,   31, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1F9 }, 
  { 0xF1FA,   90, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1FA }, 
  { 0xF1FB,  200, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1FB }, 

  { 0xF1FC,   20, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDID_0xF1FC }
...
void DESC_API_CALL_TYPE DescTask(void)
{
  ...
  if(g_descSecureNrOfAttempts_NVM != DescGetAttemptCounterValue())
  {
      g_descSecureNrOfAttempts_NVM = DescGetAttemptCounterValue();
	    EEPM_AppWriteBlock(EEP_BLOCK_descSecureFAAflag_ID, &g_descSecureNrOfAttempts_NVM);
...
/*  ********************************************************************************
 * Function name:DescOemGetSeedLevel1
...
/*  ********************************************************************************
 * Function name:DescOemSendKeyLevel1
...
static DescBool DescOemCheckAndExtractCommTypeParam(DescOemCommControlInfo * pCommControlInfo, DescMsgItem comType)
{
  ...
  /* if(((comType & 0x0F) <= kDescCommControlMsgTypeAll) &&
     ((comType & 0x0F) != 0))*/
if((comType == 0x01) ||(comType == 0x02) ||(comType == 0x03))
  {
...
/*  if((pMsgContext->reqData[0] != (vuint8)1) && (pMsgContext->reqData[0] != (vuint8)3))   //By GGL
  {
      errorCode = kDescNrcRequestOutOfRange;
  }*/
  
  if((0 == PendingVehicleSpeed()) || (0 == PendingPDCM_actualGear()))
  {
...
static void DescSecurityOnceInitPowerOn(void)
{
  /* If necessary at each ECU reset - set the penality timer always */
	(void)EEPM_AppReadBlock(EEP_BLOCK_descSecureFAAflag_ID, &g_descSecureNrOfAttempts); /*read from EE*/
    g_descSecureNrOfAttempts_NVM = g_descSecureNrOfAttempts;
# if defined (DESC_ENABLE_TOTAL_ATTEMPT_COUNTER)
...
# else
     ...
     if (g_descSecureNrOfAttempts_NVM >= kDescMaxNumberOfAttempts)
  //if((g_descSecureNrOfAttempts_NVM >= kDescMaxNumberOfAttempts) || (g_descSecureNrOfAttempts_NVM != 0))
     {
         g_descSecureTimer = DescGetTicksOfMs(kDescPowerOnSecureTimer);
     }
# endif
...
#  else
    ...
    ///  newCount = 0U; //ggl 20250913  ¼ÆÊ±³¬Ê±ºó ´íÎó½âËø´ÎÊýÇåÁã
#  endif
