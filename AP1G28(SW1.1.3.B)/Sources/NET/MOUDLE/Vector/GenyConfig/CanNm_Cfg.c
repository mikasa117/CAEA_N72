...
CONST(CanNm_PbChannelConfigType, CANNM_PBCFG) CanNm_PbChannelConfig0[CANNM_NUMBER_OF_CANNM_CHANNELS] = 
{
  
  {
    ...
    CanTxNMm_VRHCU /* CANNM_TX_PDU_ID */, 
    2u /* CANNM_NODE_ID */
  }
};
...
CONST(CanNm_LChannelConfigType, CANNM_CONST) CanNm_LChannelConfig[CANNM_NUMBER_OF_CANNM_CHANNELS] = 
{
  ...
  {
    2u /* CANNM_IMMEDIATE_NM_CYCLE_TIME */, 
    300u /* CANNM_TIMEOUT_TIME */, 
    150u /* CANNM_WAIT_BUS_SLEEP_TIME */, 
    300u /* CANNM_REPEAT_MESSAGE_TIME */, 
    ...
    25u /* CANNM_IMMEDIATE_NM_TRANSMISSIONS */,
    1u  /*CANNM_ACTIVE_WAKE_UP_BIT_ENABLED*/   //The protocol stack cannot be configured.
  }
};
#define CANNM_STOP_SEC_CONST_UNSPECIFIED
/* PRQA S 5087 1 */ /* MD_MSR_19.1 */
