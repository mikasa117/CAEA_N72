...
#define NM_PROD_ERROR_DETECT STD_OFF
...
#define NM_PRECOMPILE_CRC                    (uint32) 0x8256BAD2u
...
#define UL_Nm_StateChangeNotification        ApplCbdWrpStateChange

/* Indication that a Pdu has been received */
...
#endif
extern void ApplCbdWrpStateChange(NetworkHandleType nmChannelHandle, Nm_StateType nmPreviousState, Nm_StateType nmCurrentState ); //Compilation error
