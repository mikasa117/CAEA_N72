 ...
 *  4.23.00   2014-02-25  vissrk  ESCAN00073880 No changes in this file
 *                                ESCAN00073913 No changes in this file
 *  4.24.00   2016-01-18  vismdr  ESCAN00083394 No changes in this file
 *  4.25.00   2017-03-29  vissrk  ESCAN00094383 No changes in this file
 *                                ESCAN00094536 No changes in this file
 *  4.26.00   2017-06-14  vissrk  ESCAN00095546 No changes in this file
 *********************************************************************************************************************/
...
#define NM_ASRNMCAN_VERSION          (0x0426u)
#define NM_ASRNMCAN_RELEASE_VERSION  (0x00u)
...
extern uint8 CanApp_GetImmediateNmTxFlag(void);   //The demand is not clear as to whether an NM message should be sent immediately.
...
#include "MemMap.h"  /* PRQA S 5087 */ /* MD_MSR_19.1 */
    ...
    ( CANNM_FORWARD_TX_CONFIRMATION == STD_ON ) )
# define CANNM_START_SEC_APPL_CODE
# include "MemMap.h"  /* PRQA S 5087 */ /* MD_MSR_19.1 */

 extern FUNC( void, CANNM_APPL_CODE ) Appl_CanNm_TxConfirmation( CONST( NetworkHandleType, AUTOMATIC ) nmChannelHandle );

# define CANNM_STOP_SEC_APPL_CODE
# include "MemMap.h"  /* PRQA S 5087 */ /* MD_MSR_19.1 */
#endif
