...
#ifndef STD_ON           //Prevent the repetition of macro names between handwritten code and protocol stack code
# define STD_ON       1u
#endif                   //Prevent the repetition of macro names between handwritten code and protocol stack code
#ifndef STD_OFF          //Prevent the repetition of macro names between handwritten code and protocol stack code
# define STD_OFF      0u
#endif                   //Prevent the repetition of macro names between handwritten code and protocol stack code
/**********************************************************************************************************************
...
# ifndef E_OK    //Prevent the repetition of macro names between handwritten code and protocol stack code
#  define E_OK      0u
#endif           //Prevent the repetition of macro names between handwritten code and protocol stack code
typedef unsigned char StatusType; /* OSEK compliance */
# endif
# ifndef E_NOT_OK //Prevent the repetition of macro names between handwritten code and protocol stack code
# define E_NOT_OK  1u
#endif            //Prevent the repetition of macro names between handwritten code and protocol stack code
