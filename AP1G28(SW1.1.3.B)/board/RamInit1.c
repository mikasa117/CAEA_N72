...
extern uint32_t NamDE_RAM2_ram_start[1U];
extern uint32_t NamDE_RAM2_rom_start[1U];
extern uint32_t NamDE_RAM2_rom_end[1U];
extern uint32_t DATA_RAM2_ram_start[1U];
extern uint32_t DATA_RAM2_rom_start[1U];
extern uint32_t DATA_RAM2_rom_end[1U];
...
const RamCopyLayoutType CopyLayout[4]={
    ...
    {
        .RamStart=NamDE_RAM2_ram_start,
        .RomStart=NamDE_RAM2_rom_start,
        .RomEnd=NamDE_RAM2_rom_end,
        .InitType=INIT_NORMAL,
    },
    {
        .RamStart=DATA_RAM2_ram_start,
        .RomStart=DATA_RAM2_rom_start,
        .RomEnd=DATA_RAM2_rom_end,
        .InitType=INIT_NORMAL,
    },
};
