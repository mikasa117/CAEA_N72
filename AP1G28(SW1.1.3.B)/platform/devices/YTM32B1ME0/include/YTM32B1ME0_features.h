...
#define FEATURE_CLOCK_TIMEOUT_LOOP_CHECK_CNT      (0xF0U)
...
#define FEATURE_EFM_OPERATION_CLOCK_SOURCE   (CORE_CLK)
...
/* @brief Flash Boot NVR address */
#define FEATURE_EFM_BOOT_NVR_ADDR                      (0x10020000u)
...
#define EFM_BOOT_SWAP_UNLOCK()                                 \
    do                                                         \
    {                                                          \
        *(volatile uint32_t *)(EFM_BASE + 0x0304) = 0x65fe9aU; \
    } while (0)
...
#define I2C_STATE_PTR                                   {NULL, NULL, NULL}
/* @brief Slave mode support I2C module. */
#define I2C_SLAVE_SUPPORT                               {true, true, true}
...
typedef enum {
    ...
    WDG0_CLK                 = 51U, /*!< WDG0       clock source */
    EWDG0_CLK                = 52U, /*!< EWDG0      clock source */
    INTM_CLK                 = 53U, /*!< INTM       clock source */
    EMU0_CLK                 = 54U, /*!< EMU0       clock source */
...
{                                \
    ...
    IPC_PLL_INDEX,            /*!< PLL        clock source  133u */ \
...
/* @brief Errata of DMA E406002 */
#define FEATURE_DMA_ERRATA_E406002 (1U)
...
enum tmu_target_module_e
{
    ...
    TMU_TARGET_MODULE_ADC1_EXT_TRIG                  = 16U,
...
#define FEATURE_TMU_TARGET_MODULE                     \
    ...
    TMU_TARGET_MODULE_ADC1_EXT_TRIG,                  \
...
#define FEATURE_ADC_MAX_NUM_EXT_CHANS                     (31)
...
#define FEATURE_FLEXCAN_STATE_PTR           { NULL, NULL, NULL, NULL, NULL, NULL }
...
#define FEATURE_CAN0_HAS_HR_TIMESTAMP (1U)
/* @brief High-resolution time stamp feature for CAN1 */
#define FEATURE_CAN1_HAS_HR_TIMESTAMP (1U)
/* @brief High-resolution time stamp feature for CAN2 */
#define FEATURE_CAN2_HAS_HR_TIMESTAMP (1U)
/* @brief High-resolution time stamp feature for CAN3 */
#define FEATURE_CAN3_HAS_HR_TIMESTAMP (1U)
/* @brief High-resolution time stamp feature for CAN4 */
#define FEATURE_CAN4_HAS_HR_TIMESTAMP (1U)
/* @brief High-resolution time stamp feature for CAN5 */
#define FEATURE_CAN5_HAS_HR_TIMESTAMP (1U)
/* @brief High-resolution time stamp feature for all CAN */
#define FEATURE_CAN_HAS_HR_TIMESTAMP (1U)
...
#define FEATURE_CAN_INSTANCES_HAS_HR_TIMESTAMP           { FEATURE_CAN0_HAS_HR_TIMESTAMP, \
                                                           ...
                                                           FEATURE_CAN3_HAS_HR_TIMESTAMP, \
                                                           FEATURE_CAN4_HAS_HR_TIMESTAMP, \
                                                           FEATURE_CAN5_HAS_HR_TIMESTAMP }
