...
#define CCL_DISABLE_NMASR_WAKEUP_VALIDATION
...
#define CCL_IgnRequest    1
#define CCL_DiagReqquest    2
/***************************************************************************/ 
/* Macros                                                                  */ 
/***************************************************************************/ 
...
#define CclSet_IgnRequest()                           CclRequestCommunication(CCL_IgnRequest)
#define CclSet_DiagReqquest()                             CclRequestCommunication(CCL_DiagReqquest)


  /* *** Release Communication access macros *** */
#define CclRel_IgnRequest()                           CclReleaseCommunication(CCL_IgnRequest)
#define CclRel_DiagReqquest()                             CclReleaseCommunication(CCL_DiagReqquest)
