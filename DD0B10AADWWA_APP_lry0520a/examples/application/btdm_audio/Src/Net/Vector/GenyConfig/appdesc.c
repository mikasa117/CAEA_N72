/* -----------------------------------------------------------------------------
  ...
  Description: Implementation example for the proper usage with CANdesc.
                ...
                Manufacturer: Vector
                EcuDocFile:   C:\Users\Administrator\Desktop\DD0B66BACWWA-E-CDD$CDD.cdd
                Variant:      CommonDiagnostics

  Generated by CANdelaGen, Fri Jul 11 19:24:09 2025
...
#define CeDemIdentifiersNumber 6u
...
/* 64Bit seed stored for the later key compare */
 vuint32 g_applDescSeedX_1;
 vuint32 g_applDescSeedX_2;
...
{
   float32 LeAppdesc_u_VehicleSpeed = Rte_Read_EHB_VehicleSpeed();
  uint8 SpeedValid   = Rte_Read_EHB_VehicleSpeedInvalid();  // 获取车辆速度有效�
  /* <<TBD>> Remove this comment once you have completely implemented this function!!! */
  /* Contains no request data */
  /* Contains no response data */
  /* User service processing finished. */

  if((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
...
void DESC_API_CALLBACK_TYPE ApplDescClearDiagInfo(DescMsgContext* pMsgContext)
{
    ...
    if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
    {
				...
				{
					if(CanDem_u_Nok == CanDem_DcmClearDTCSignal(LeAppdesc_u_Temp))
					{
					...
					{
						DescSetNegResponse(( DescNegResCode )kDescNrcGeneralProgrammingFailure);
					}
				}
    }
		else
...
void DESC_API_CALLBACK_TYPE ApplDescReadDtcRNODTCBSM(DescMsgContext* pMsgContext)
{
    ...
    if((LeAppdesc_u_RequestMask == 0x01) || (LeAppdesc_u_RequestMask == 0x08) || (LeAppdesc_u_RequestMask == 0x09))
    {
      pMsgContext->resDataLen = 4u;
      pMsgContext->resData[0] = 0x09u;  /*DTCStatusAvailabilityMask*/
      pMsgContext->resData[1] = 0x04u;  /*Dem_DcmGetTranslationType();*/
...
void DESC_API_CALLBACK_TYPE ApplDescReadDtcRDTCBSM(DescMsgContext* pMsgContext)
{
    ...
    if((LeAppdesc_u_RequestMask == 0x01) || (LeAppdesc_u_RequestMask == 0x08) || (LeAppdesc_u_RequestMask == 0x09))
    {
        ...
        for(LeAppdesc_w_DTCNumberIndex=0;LeAppdesc_w_DTCNumberIndex<LeAppdesc_u_MaskNumber;LeAppdesc_w_DTCNumberIndex++)
        {
            ...
            pMsgContext->resData[LeAppdesc_w_Index + 3U] = LeAppdesc_u_DTCStatus;
...
void DESC_API_CALLBACK_TYPE ApplDescReadDtcRDTCSSBDTC(DescMsgContext* pMsgContext)
{
        ...
        || (pMsgContext->reqData[3] == 0xFF)*/) )
    {
		...
		pMsgContext->resData[3] = LeAppdesc_u_DTCStatus;

        if( (LeAppdesc_u_DTCStatus & Can_u_StatusAvailabilityMask)!= 0u)
        {
        	LeVehicleSpeed = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Speed;
        	LeFirstODO = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_FirstODO;
        	LeLastODO = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_LastODO;
        //	LeEngSpeed = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Engine;

			pMsgContext->resDataLen  = 34U;
			pMsgContext->resData[4]  = CeDemSnapRecordNumber_onlySupport;
			pMsgContext->resData[5]  = CeDemIdentifiersNumber;
			pMsgContext->resData[6]  = 0xDFU;
			pMsgContext->resData[7]  = 0x00U;
			pMsgContext->resData[8]  = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_ECU_Voltage;
			pMsgContext->resData[9]  = 0xDF;
			pMsgContext->resData[10] = 0x01;
			pMsgContext->resData[11] = (uint8)((LeVehicleSpeed >> 8) & 0xFF);
			pMsgContext->resData[12] = (uint8)(LeVehicleSpeed & 0xFF);
			pMsgContext->resData[13] = 0xDF;
			pMsgContext->resData[14] = 0x02;
			pMsgContext->resData[15] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_OccurrenceCnt;
			pMsgContext->resData[16] = 0xDF;
			pMsgContext->resData[17] = 0x03;
			pMsgContext->resData[18] = (uint8)((LeFirstODO >> 16) & 0xFF);
			pMsgContext->resData[19] = (uint8)((LeFirstODO >> 8) & 0xFF);
			pMsgContext->resData[20] = (uint8)(LeFirstODO & 0xFF);
			pMsgContext->resData[21] = 0xDF;
			pMsgContext->resData[22] = 0x04;
			pMsgContext->resData[23] = (uint8)((LeLastODO >> 16) & 0xFF);
			pMsgContext->resData[24] = (uint8)((LeLastODO >> 8) & 0xFF);
			pMsgContext->resData[25] = (uint8)(LeLastODO & 0xFF);
		//	pMsgContext->resData[26] = 0xDF;
		//	pMsgContext->resData[27] = 0x05;
		//	pMsgContext->resData[28] = (uint8)((LeEngSpeed >> 8) & 0xFF);
		//	pMsgContext->resData[29] = (uint8)(LeEngSpeed & 0xFF);
		//	pMsgContext->resData[30] = 0xDF;
		//	pMsgContext->resData[31] = 0x06;
		//	pMsgContext->resData[32] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_PowerMode;
			pMsgContext->resData[26] = 0xDD;
			pMsgContext->resData[27] = 0x00;
			pMsgContext->resData[28] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Sec;
			pMsgContext->resData[29] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Min;
			pMsgContext->resData[30] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Hour;
			pMsgContext->resData[31] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Month;
			pMsgContext->resData[32] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Day;
			pMsgContext->resData[33] = SeDem_u_DTCInfo[LeAppdesc_dw_DTCIndex].DTCSnapShotData.e_u_Year;
        }
        else
        {
        }
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xD135_PKC1 (Service request header:$2E $D1 $35 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xD135_PKC1(DescMsgContext* pMsgContext)
{
    ...
    if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
    {
			if((uint8)0u == DID_WriteDid0xD135( pMsgContext->reqData ))
			{
				;
			}
			else
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xF101_ECU_Function_Configuration (Service request header:$2E $F1 $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xF101_ECU_Function_Configuration(DescMsgContext* pMsgContext)
{
   ...
   uint8 SpeedValid  = Rte_Read_EHB_VehicleSpeedInvalid();  // 获取车辆速度有效�
	...
	if((LeAppdesc_u_VehicleSpeed <= 3.0f)&& (SpeedValid == 0u))
	{
		if((uint8)E_OK == DID_WriteDid0xF101( pMsgContext->reqData ))
		{
			;
		}
		else
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xF110_Vehicle_Network_Configuration (Service request header:$2E $F1 $10 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xF110_Vehicle_Network_Configuration(DescMsgContext* pMsgContext)
{
    ...
    if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
    {
		if((uint8)E_OK == DID_WriteDid0xF110( pMsgContext->reqData ))
		{
			;
		}
		else
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xF112_Vehicle_Name (Service request header:$2E $F1 $12 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xF112_Vehicle_Name(DescMsgContext* pMsgContext)
{
    ...
    if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
    {
		if((uint8)E_OK == DID_WriteDid0xF112( pMsgContext->reqData ))
		{
			;
		}
		else
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xF190_VIN_DataIdentifier (Service request header:$2E $F1 $90 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xF190_VIN_DataIdentifier(DescMsgContext* pMsgContext)
{
	...
	if((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
	{
		if((uint8)E_OK == DID_WriteDid0xF190( pMsgContext->reqData ))
		{
			;
		}
		else
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xF197_System_name (Service request header:$2E $F1 $97 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xF197_System_name(DescMsgContext* pMsgContext)
{
  ...
  uint8 SpeedValid  = Rte_Read_EHB_VehicleSpeedInvalid();  // 获取车辆速度有效�
	...
	if((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
	{
		if((uint8)E_OK == DID_WriteDid0xF197( pMsgContext->reqData ))
		{
			;
		}
		else
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidDID_0xF1A2_ECU_Installation_Date (Service request header:$2E $F1 $A2 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescWriteDidDID_0xF1A2_ECU_Installation_Date(DescMsgContext* pMsgContext)
{
    ...
    if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
    {
		if((uint8)E_OK == DID_WriteDid0xF1A2( pMsgContext->reqData ))
		{
			;
		}
		else
...
void DESC_API_CALLBACK_TYPE ApplDescControlDtcSettingEnable(DescMsgContext* pMsgContext)
{
  ...
  /* User service processing finished. */
	...
	if((LeApplDesc_u_ErrorCode == kDescNrcNone) && (LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
	{
...
/* Contains no response data */
/* User service processing finished. */
	DescSetNegResponse(( DescNegResCode )kDescNrcServiceNotSupportedInActiveSession);
	DescProcessingDone();
}
...
/*  *********************************************************************************/
 /* Function name:ApplDescIoCtrlRetCtrlToEcuCPID_0XFF00_Clear_all_control (Service request header:$2F $FF $0 $0 )
 * Description:
 * 
 * 
 * 
 ...
 * but before calling "DescProcessingDone".
 ********************************************************************************  */
void DESC_API_CALLBACK_TYPE ApplDescIoCtrlRetCtrlToEcuCPID_0XFF00_Clear_all_control(DescMsgContext* pMsgContext)
{
  /* <<TBD>> Remove this comment once you have completely implemented this function!!! */
  /* Contains no request data */
  /* Contains no response data */
...
void DESC_API_CALLBACK_TYPE ApplDescCheckCommCtrl(DESC_CONTEXT_FORMAL_PARAM_DEF_FIRST DescOemCommControlInfo *commControlInfo)
{
  ...
  if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))
  {
        if(commControlInfo->rxPathState == 0) //disable rx
	  {
		  if(commControlInfo->txPathState == 0)//disable rx and tx 28 03
		  {
			  if(commControlInfo->msgTypes == 3)//disable all
			  {
				  CanApp_Set28RxStop(TRUE);
				  IlRxStop();
				  IlTxStop();
			  }
			  else if(commControlInfo->msgTypes == 2) //nm
			  {
				 /* Nm_DisableCommunication(0);*/// 禁止TX NM报文
				 // Nm_DisableRxCommunication(0); // 禁止RX NM报文
			  }
			  else if(commControlInfo->msgTypes == 1)//app
			  {
				  CanApp_Set28RxStop(TRUE);
				  IlRxWait();
				  IlTxWait();
		  ...
		  else if(commControlInfo->txPathState == 1)//disable rx and enable tx 28 02
		  {
			  if(commControlInfo->msgTypes == 3)//disable all
			  {
				  CanApp_Set28RxStop(TRUE);
			  ...
			  {
				//	Nm_DisableRxCommunication(0); // 禁止RX NM报文
				//	Nm_EnableCommunication(0);   // 使能TX NM报文
			  }
			  else if(commControlInfo->msgTypes == 1)//app
			  {
				  CanApp_Set28RxStop(TRUE);
	  ...
	  else if(commControlInfo->rxPathState == 1) //enablb rx
	  {
		  if(commControlInfo->txPathState == 0)//enable rx and disable tx  28 01
		  {
			  if(commControlInfo->msgTypes == 3)//all
			  {
					CanApp_Set28RxStop(FALSE);
				  IlRxStart();
				  IlTxStop();
			  ...
			  {
				//Nm_DisableCommunication(0);  // 禁止TX NM报文
				//Nm_EnableRxCommunication(0); // 使能RX NM报文 	
			  }
			  else if(commControlInfo->msgTypes == 1)//app
			  {
					CanApp_Set28RxStop(FALSE);
		  ...
		  else if(commControlInfo->txPathState == 1)//enable rx and enable tx 28 00
		  {
			  if(commControlInfo->msgTypes == 3)//enable all
			  {
					CanApp_Set28RxStop(FALSE);
				  IlRxStart();
				  IlTxStart();
...
void DESC_API_CALLBACK_TYPE ApplDescCheckSessionTransition(DescStateGroup newState, DescStateGroup formerState)
{
    ...
    {
		if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u))//  && (0u == Rte_Read_PMS_ePTReady()))
        //if ((LeAppdesc_u_VehicleSpeed <= 3.0f) && (SpeedValid == 0u) && (0u == PWM_GetHwIgnStatus()) && (0u == Rte_Read_PMS_ePTReady()))
        {
 ...
 *   - The function "DescSetNegResponse" may be called.
 ******************************************************************************** */
extern uint8 ReqSeedBuf[8];
static uint8 SeedBuf[16] __attribute__((aligned(4))) = {0x00};
void ApplDescSecurityAccessGetSeed(DescSecurityAccessContext* pDescSecurityAccessContext)
{
	    ...
	    GetSeed(SECURITY_SEED_SIZE,&SeedBuf[0]);

		memcpy(&(pDescSecurityAccessContext->dataPtr[0]),SeedBuf,8);
    	memcpy(&SeedBuf[8],ReqSeedBuf,8);
...
void ApplDescSecurityAccessCheckKey(DescSecurityAccessContext* pDescSecurityAccessContext)
{
  ...
  if (IsReceivedKeyRight(pDescSecurityAccessContext->dataPtr, SeedBuf) != 0)
  {
    /* Key is INVALID */
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0x0200_Programming_Counter (Service request header:$22 $2 $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	uint8 LeApplDesc_u_RetCode;

	LeApplDesc_u_RetCode = RteDcm_ReadDid0x0200( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_0200_LEN;
	}
	else
	{
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0x0201_Programming_Attemp_Counter (Service request header:$22 $2 $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0x0201_Programming_Attemp_Counter(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0x0201( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_0201_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xD201_The_Number_Of_Cameras_In_Use (Service request header:$22 $75 $01 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0x7501(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0x7501( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_7501_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0x7502 (Service request header:$22 $75 $2 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0x7502(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0x7502( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_7502_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF101_ECU_Function_Configuration (Service request header:$22 $F1 $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF101_ECU_Function_Configuration(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF101( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F101_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF110_Vehicle_Network_Configuration (Service request header:$22 $F1 $10 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF110_Vehicle_Network_Configuration(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF110( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F110_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF112_Vehicle_Name (Service request header:$22 $F1 $12 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF112_Vehicle_Name(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF112( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F112_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF113_Diagnostic_Version (Service request header:$22 $F1 $13 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF113_Diagnostic_Version(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF113( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F113_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF180_Boot_Software_Identification (Service request header:$22 $F1 $80 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF180_Boot_Software_Identification(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF180( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F180_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF182_Calibration_Software_Version_Number (Service request header:$22 $F1 $82 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF182_Calibration_Software_Version_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF182( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F182_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF186_Active_Diagnostic_Session (Service request header:$22 $F1 $86 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF186_Active_Diagnostic_Session(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF186( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F186_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF187_Geely_Spare_Part_Number (Service request header:$22 $F1 $87 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF187_Geely_Spare_Part_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF187( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F187_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF189_Manufacturer_ECU_Software_Version_Number (Service request header:$22 $F1 $89 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF189_Manufacturer_ECU_Software_Version_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF189( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F189_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF18A_System_Supplier_Identifier_Data (Service request header:$22 $F1 $8A )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF18A_System_Supplier_Identifier_Data(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF18A( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F18A_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF18B_ECU_Manufacturing_Date (Service request header:$22 $F1 $8B )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF18B_ECU_Manufacturing_Date(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF18B( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F18B_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF18C_ECU_serial_number (Service request header:$22 $F1 $8C )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF18C_ECU_serial_number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF18C( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F18C_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF190_VIN_DataIdentifier (Service request header:$22 $F1 $90 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF190_VIN_DataIdentifier(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF190( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F190_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF191_Manufacturer_ECU_Hardware_Version_Number (Service request header:$22 $F1 $91 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF191_Manufacturer_ECU_Hardware_Version_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF191( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F191_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF193_System_Supplier_ECU_Hardware_Version_Number (Service request header:$22 $F1 $93 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF193_System_Supplier_ECU_Hardware_Version_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF193( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F193_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF195_System_Supplier_ECU_Software_Version_Number (Service request header:$22 $F1 $95 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF195_System_Supplier_ECU_Software_Version_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF195( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F195_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF197_System_name (Service request header:$22 $F1 $97 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF197_System_name(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF197( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F197_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF198_Repair_Shop_Code_Or_TesterSerial_Number (Service request header:$22 $F1 $98 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF198_Repair_Shop_Code_Or_TesterSerial_Number(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF198( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F198_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF199_Programming_Or_Configuration_Date (Service request header:$22 $F1 $99 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF199_Programming_Or_Configuration_Date(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF199( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F199_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidDID_0xF1A2_ECU_Installation_Date (Service request header:$22 $F1 $A2 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidDID_0xF1A2_ECU_Installation_Date(DescMsgContext* pMsgContext)
{
	...
	LeApplDesc_u_RetCode = RteDcm_ReadDid0xF1A2( pMsgContext->resData );

	if( kDescNrcNone == LeApplDesc_u_RetCode )
	{
		pMsgContext->resDataLen = DID_F1A2_LEN;
	}
	else
	{
		DescSetNegResponse( (DescNegResCode )LeApplDesc_u_RetCode );
...
/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartcheckProgrammingPreconditions (Service request header:$31 $1 $D0 $3 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
