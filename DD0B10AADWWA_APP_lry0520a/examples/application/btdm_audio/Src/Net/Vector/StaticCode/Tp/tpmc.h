...
| 2011-12-14  3.06.05  Dth   ESCAN00052470: declaration of TpRxCanMessageReceived changed to TpRxCanMessageTransmitted
| 2012-01-24  3.07.00  Dth   ESCAN00053735: default value for TP_USE_UNEXPECTED_FC_CANCELATION added
|                      Dth   ESCAN00056224: default value for TP_ENABLE_TX_ERR_ON_RX_FC_WAIT & error kTpTxErrUnsupportedFCWait added
| 2012-04-02  3.07.01  Dth   ESCAN00057225: no changes
...
| 2012-04-13  3.07.02  Dth   ESCAN00058320: corruption of data due to union access
| 2012-07-25  3.07.03  Dth   ESCAN00060198: Compiler error with dynamic TP and normal+extended addressing use case
| 2013-03-21  3.07.04  Dth   ESCAN00066083: no changes
...
|                      Dth   ESCAN00066741: no changes
| 2013-08-23  3.08.01  Dth   ESCAN00069636: Compiler error: tpCanRxActualIdType is undefined
|                      Dth   ESCAN00069776: no changes
|                      Dth   ESCAN00069980: no changes
| 2014-09-03  3.08.02  Dth   ESCAN00075459: no changes
| 2015-03-11  3.08.03  Dth   ESCAN00080573: no changes
| 2016-09-13  3.08.04  Ath   ESCAN00091857: no changes
...
|                      Suk   ESCAN00096111  no changes
|                      Suk   ESCAN00096112  no changes
| 2017-08-17  3.09.02  Ath   ESCAN00096066  no changes
|                      Ath   ESCAN00096072  no changes
|                      Ath   ESCAN00096077  no changes
|                      Ath   ESCAN00096079  no changes
|                      Ath   ESCAN00096080  no changes
|                      Suk   ESCAN00096239  no changes
|                      Suk   ESCAN00096244  no changes
|                      Suk   ESCAN00096245  no changes
|                      Suk   ESCAN00096115  no changes
...
#define TP_ISO15765_VERSION           0x0401
#define TP_ISO15765_RELEASE_VERSION   0x00
...
#  ifndef TP_ENABLE_NORMAL_FIXED_ADDRESSING
...
# endif
#else 
# if (!defined(TP_ENABLE_NORMAL_FIXED_ADDRESSING) && !defined(TP_DISABLE_NORMAL_FIXED_ADDRESSING))
 #define TP_DISABLE_NORMAL_FIXED_ADDRESSING
# endif
#endif
#if defined (TP_USE_EXTENDED_ADDRESSING)
# if (TP_USE_EXTENDED_ADDRESSING == kTpOn)
#  ifndef TP_ENABLE_EXTENDED_ADDRESSING
...
# endif
#else 
# if (!defined(TP_ENABLE_EXTENDED_ADDRESSING) && !defined(TP_DISABLE_EXTENDED_ADDRESSING))
 #define TP_DISABLE_EXTENDED_ADDRESSING
# endif
#endif
#if defined (TP_USE_MIXED_29_ADDRESSING)
# if (TP_USE_MIXED_29_ADDRESSING == kTpOn)
#  ifndef TP_ENABLE_MIXED_29_ADDRESSING
...
# endif
#else 
# if (!defined(TP_ENABLE_MIXED_29_ADDRESSING) && !defined(TP_DISABLE_MIXED_29_ADDRESSING))
 #define TP_DISABLE_MIXED_29_ADDRESSING
# endif
#endif
#if defined (TP_USE_MIXED_11_ADDRESSING)
# if (TP_USE_MIXED_11_ADDRESSING == kTpOn)
#  ifndef TP_ENABLE_MIXED_11_ADDRESSING
...
# endif
#else 
# if (!defined(TP_ENABLE_MIXED_11_ADDRESSING) && !defined(TP_DISABLE_MIXED_11_ADDRESSING))
 #define TP_DISABLE_MIXED_11_ADDRESSING
# endif
#endif
#if defined (TP_USE_DYN_ID)
# if (TP_USE_DYN_ID == kTpOn)
#  ifndef TP_ENABLE_DYNAMIC_CHANNELS
...
# endif
#else 
# if (!defined(TP_ENABLE_DYNAMIC_CHANNELS) && !defined(TP_DISABLE_DYNAMIC_CHANNELS))
...
#endif
#if ( (!defined(VGEN_ENABLE_TP_MCAN)) && (!defined(VGEN_DISABLE_TP_MCAN)) )
...
#if !defined (TP_USE_UNEXPECTED_FC_CANCELATION)
# define TP_USE_UNEXPECTED_FC_CANCELATION     kTpOff
#endif

#if !defined (TP_USE_MICROSEC_STMIN)
# define TP_USE_MICROSEC_STMIN                kTpOn
#endif

#if ! ( defined(TP_ENABLE_TX_ERR_ON_RX_FC_WAIT) || defined(TP_DISABLE_TX_ERR_ON_RX_FC_WAIT) )
# define TP_DISABLE_TX_ERR_ON_RX_FC_WAIT
#endif
...
#if ! (defined (TP_ENABLE_CANCEL_FC_RES_STMIN) || defined(TP_DISABLE_CANCEL_FC_RES_STMIN) )
...
#  if !defined (kTpPhysPGNNormalFixed)
#   if defined (kTpPhysPGN)
#    define kTpPhysPGNNormalFixed kTpPhysPGN
#   else
#    error "Either kTpPhysPGN or kTpPhysPGNNormalFixed must be defined if NormalFixed addressing is active"
#   endif
#  endif
# endif
# if defined (TP_ENABLE_MIXED_29_ADDRESSING)
#  if !defined (kTpPhysPGNMixed29)
#   if defined (kTpPhysPGN)
#    define kTpPhysPGNMixed29 kTpPhysPGN
#   else
#    error "Either kTpPhysPGN or kTpPhysPGNMixed29 must be defined if Mixed29 addressing is active"
#   endif
#  endif
# endif
/* Define Prio */
# if defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)
#  if !defined (kTpPhysPrioNormalFixed)
#   if defined (kTpPhysPrio)
#    define kTpPhysPrioNormalFixed kTpPhysPrio
#   else
#    error "Either kTpPhysPrioNormalFixed or kTpPhysPrio must be defined if NormalFixed addressing is active"
#   endif
#  endif
# endif
# if defined (TP_ENABLE_MIXED_29_ADDRESSING)
#  if !defined (kTpPhysPrioMixed29)
#   if defined (kTpPhysPrio)
#    define kTpPhysPrioMixed29 kTpPhysPrio
#   else
#    error "Either kTpPhysPrioMixed29 or kTpPhysPrio must be defined if Mixed29 addressing is active"
#   endif
#  endif
# endif
...
#if !defined (kTpTimeoutFactorCF)
# define kTpTimeoutFactorCF     (1)
#endif

#if !defined (kTpTimeoutFactorFC)
# define kTpTimeoutFactorFC     (1)
#endif

/* internal switch to cover special use case (physical normal addressing & functional extended addressing) */
#if defined (TP_ENABLE_NORMAL_ADDRESSING) && \
    defined (TP_FUNC_ENABLE_EXTENDED_ADDRESSING)
# define TP_ENABLE_PHYS_NORMAL_EXT_FUNC_ADDRESSING
#endif
...
# error Please enable extended IDs in the generation tool 
# endif
#endif
/* Addressing */
#if defined (TP_ENABLE_MULTIPLE_ADDRESSING) 
...
#   if defined (TP_ENABLE_EXTENDED_ADDRESSING)     || \
       ...
       defined (TP_ENABLE_MIXED_29_ADDRESSING)
#   error Not only mixed 11 bit addressing and normal addressing is selected
#   endif
#  else
#   if defined (TP_ENABLE_EXTENDED_ADDRESSING)     || \
       defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING) || \
       defined (TP_ENABLE_MIXED_29_ADDRESSING)     || \
       defined (TP_ENABLE_MIXED_11_ADDRESSING)
#   error More than one addressing method is selected
#   endif
#  endif
# endif
...
# if defined (TP_ENABLE_EXTENDED_ADDRESSING)
#  if defined( TP_TYPE_MULTI_MULTIPLE_ADDRESSING )
#   error multiple baseaddresses is not supported with multiple addressing
#  endif
# else
...
# if defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  ||\
     defined (TP_ENABLE_MIXED_29_ADDRESSING)
# error Dynamic ID have to be defined on
# endif
#endif
...
#if defined (TP_ENABLE_EXTENDED_ADDRESSING)
# if (TP_USE_FAST_PRECOPY == kTpOn)
#error The Fast Precopy Mode is not supported with extended addressing
# endif
#endif
...
# if ((TP_USE_PADDING == kTpOn ) && (defined(TP_DISABLE_CANFD)))
# error If CAN FD is not enabled, padding cannot be combined with variable DLC. Deactivate one option.
# endif
#endif
...
#if defined (TP_ENABLE_DYN_TX_STMIN_TIMING) &&  !defined(TP_ENABLE_DYNAMIC_CHANNELS)
# error Dynamic timings only available for dynamic multi channel configurations
#endif

#if defined (TP_ENABLE_DYN_CHANNEL_TIMING) &&  !defined(TP_ENABLE_DYNAMIC_CHANNELS)
# error Dynamic timings only available for dynamic multi channel configurations
#endif

#if defined ( TP_ENABLE_SINGLE_CHAN_MULTICONN )
# if defined ( TP_ENABLE_SINGLE_CHANNEL_TP ) && \
    (defined( TP_ENABLE_NORMAL_ADDRESSING ) || defined( TP_ENABLE_MIXED_11_ADDRESSING )) 
# else
...
/* WFTmax not defined: derive WFTmax value from ENABLE_FC_WAIT switch */
# if defined( TP_ENABLE_FC_WAIT )
#  define kTpWFTmax     0xFF
# else
#  define kTpWFTmax     0x01
# endif
typedef vuint8 tWFTmaxType;

#else
/* WFTmax defined: derive ENABLE_FC_WAIT switch setting from WFTmax value */
# if ( kTpWFTmax > 0 )
#  if !defined( TP_ENABLE_FC_WAIT )
#   define TP_ENABLE_FC_WAIT
#  endif
#  if ( kTpWFTmax > 255 )
typedef vuint16 tWFTmaxType;
#  else
typedef vuint8 tWFTmaxType;
#  endif
# else
...
#if defined (TP_ENABLE_DYNAMIC_CHANNELS)
# if defined(TP_DISABLE_MF_RECEPTION)
#  error MultiFrame disabling currently only supported for Static TP classes.
# endif
#endif

#if defined(TP_ENABLE_MULTIPLE_ADDRESSING) && (TP_USE_MIXED_29_ADDRESSING == kTpOn) && !defined(TP_INVALID_ADDRESS_EXTENSION)
# define TP_INVALID_ADDRESS_EXTENSION 0xFF
#endif
...
#define kTpRxChannelMask      0x80
#define kTpChannelMask        0x7F /* raw channel without TX/RX coding bit */
# endif
#endif
...
#if defined (TP_ENABLE_MULTIPLE_ADDRESSING) 
# define kTpNormalAddressing       0x01
# define kTpExtendedAddressing     0x02
# define kTpNormalFixedAddressing  0x03
# define kTpMixed29Addressing      0x04
# define kTpMixed11Addressing      0x05

# define kTpRequestAppl            0x01
# define kTpRequestDiagFunctional  0x02
# define kTpRequestDiagPhysical    0x04
#endif
...
/* CAN types */ 
#define kTpCAN20                0x00 
#define kTpCANFD1               0x01
#define kTpCANFD2               0x02
#define kTpInvalid              0xFF

#if defined(TP_ENABLE_DYNAMIC_CHANNELS)
/* Max Payload */
#define kTpCAN20MaxPayload      (TP_CAN20_FRAME_LENGTH - 1)
#define kTpCANFDMaxPayload       63
#endif
/***************************************************************************/
/* error codes                                                             */
/***************************************************************************/
...
#define kTpTxErrUnsupportedFCWait                     0x35
#define kTpTxErrReservedSTmin                         0x36
...
typedef canuint32 dataLengthType;
#else
typedef canuint16 dataLengthType;
#endif
...
typedef struct
{
  canbittype addressingFormat:3;    /*lint !e46*/
/* Description : Stores the addressing format while running the tpChannel     */
/* Val. range / Coding: 0..5                                                  */
/******************************************************************************/
  canbittype assignedDestination:3;    /*lint !e46*/
/* Description : Stores if the Application or Diag (phys/func) is addressed   */
/* Val. range: 1 Application, 2 Diag physical, 4 Diag functional              */
/******************************************************************************/
} tTpMultipleAddressingInfoStruct; 
typedef tTpMultipleAddressingInfoStruct SupportInfoStruct;
#endif
typedef struct 
{
...
/* Val. range / Coding: 0..4095 (wihout CAN-FD)                               */
/* Val. range / Coding: 0..4294967295 (with CAN-FD)                           */
/******************************************************************************/
#if defined (TP_ENABLE_EXTENDED_ADDRESSING)
# if (TP_USE_MULTIPLE_BASEADDRESS == kTpOn)
  canuint16 BaseAddress;
/* Description :                                                              */
...
/*               will be stored in RAM                                        */
/* Val. range / Coding: kCanIdTypeStd, kCanIdTypeExt                          */
/******************************************************************************/
#   endif
#  else
...
#   define FFDATABUFFER_SIZE 62
#   else
#   define FFDATABUFFER_SIZE 6
#   endif
#  else
#   if defined (TP_ENABLE_CANFD)
#   define FFDATABUFFER_SIZE 61
#   else
#   define FFDATABUFFER_SIZE 5
#   endif
#  endif
canuint8 FFDataBuffer[FFDATABUFFER_SIZE];
...
/* Val. range / Coding: 0..4294967295 (with CAN-FD)                           */
/******************************************************************************/
  dataLengthType LastDataIndexCF;
/* Description : Index to transmit data - used instead of DataSegments        */
/* Val. range / Coding: 0..4095                                               */
/* Val. range / Coding: 0..4294967295 (with CAN-FD)                           */
/******************************************************************************/
...
/******************************************************************************/
  ...
  canbittype isRequestPending:1;       /*lint !e46*/
/* Description : Indicates if a request is pending                            */
/* Val. range / Coding: 0 = no request pending, 1 = request pending           */
/******************************************************************************/
#endif
...
# endif
    ...
    defined (TP_ENABLE_MIXED_29_ADDRESSING)
# if defined (TP_ENABLE_RUNTIME_CHECK)
  canbittype TargetAddressIsValid:1;        /*lint !e46*/
/* Description : Stores validity for member 'TargetAddress'                   */
/* Val. range / Coding: 0..1                                                  */
/******************************************************************************/
# endif
#endif
...
# if ( kTpNumberOfCanChannels > 1 ) /* more than one canChannel ? */
#  if defined (TP_ENABLE_DYNAMIC_CHANNELS)
extern void     TP_API_CALL_TYPE TpCanChannelInit(canuint8 canChannel);
#  endif
# endif
#endif
...
#  if defined (C_MULTIPLE_RECEIVE_CHANNEL)         || \
      defined (C_SINGLE_RECEIVE_CHANNEL)           
extern canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(CanRxInfoStructPtr rxStruct, SupportInfoStruct supportInfo);
#  else
#   if defined (C_MULTIPLE_RECEIVE_BUFFER)
extern canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(CanChipDataPtr rxDataPtr, SupportInfoStruct supportInfo);
#   endif
#   if defined (C_SINGLE_RECEIVE_BUFFER)
extern canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(CanReceiveHandle rxObject, SupportInfoStruct supportInfo);
#   endif
#  endif
# endif
...
/* Single Channel API */
#if defined (TP_ENABLE_SINGLE_CHANNEL_TP)
  extern canuint8 TP_API_CALL_TYPE TpTransmit(TP_MEMORY_MODEL_DATA canuint8* ptrData, dataLengthType count);
  extern void     TP_API_CALL_TYPE TpTxResetChannel(void);

# if defined (TP_ENABLE_EXTENDED_ADDRESSING)      || \
     defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  || \
     defined (TP_ENABLE_MIXED_29_ADDRESSING)
  extern void     TP_API_CALL_TYPE TpTxSetTargetAddress(canuint8 address);
# endif
...
# if (kTpNumberOfCanChannels > 1)
#  if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  extern canuint8 TP_API_CALL_TYPE TpTxGetCanChannel(void);
  extern void     TP_API_CALL_TYPE TpTxSetCanChannel(canuint8 canChannel);
#  endif
# endif
#  if defined (TP_ENABLE_DYNAMIC_CHANNELS)
#   if ((defined (TP_ENABLE_NORMAL_ADDRESSING)) || (defined (TP_ENABLE_MIXED_11_ADDRESSING)))
...
#    if (TP_USE_MIXED_IDS_FOR_NORMAL == kTpOn)
  extern void      TP_API_CALL_TYPE TpTxSetChannelExtID(canuint32 transmitID, canuint32 receiveID);
  extern void      TP_API_CALL_TYPE TpTxSetChannelID   (canuint16 transmitID, canuint16 receiveID);
...
# if defined(TP_ENABLE_DYNAMIC_CHANNELS) && defined(TP_ENABLE_CANFD)
  extern void     TP_API_CALL_TYPE TpTxSetCanType(canuint8 canType);
  extern canuint8 TP_API_CALL_TYPE TpTxGetCanType(void);
  extern canuint8 TP_API_CALL_TYPE TpRxGetCanType(void);
# endif
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)         || \
...
# if defined (TP_ENABLE_MIXED_29_ADDRESSING)      || \
     defined (TP_ENABLE_MIXED_11_ADDRESSING)
  extern void TP_API_CALL_TYPE TpTxSetAddressExtension(canuint8 addressExtension);
# endif
...
# if defined (TP_ENABLE_EXTENDED_ADDRESSING)      || \
     defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  || \
     defined (TP_ENABLE_MIXED_29_ADDRESSING)
  extern canuint8 TP_API_CALL_TYPE TpRxGetSourceAddress(void);
  extern canuint8 TP_API_CALL_TYPE TpRxGetReceivedTargetAddress(void);
# endif
# if (TP_USE_MULTIPLE_ECU_NR == kTpOn)
...
# if defined (TP_ENABLE_MIXED_29_ADDRESSING)      || \
     defined (TP_ENABLE_MIXED_11_ADDRESSING)
  extern canuint8 TP_API_CALL_TYPE TpRxGetAddressExtension(void);
# endif
# if defined (TP_TEST_ROUTINE_CONF_TIMEOUT)
...
# endif
  ...
  extern canuint8 TP_API_CALL_TYPE TpTransmit                   (canuint8 tpChannel, TP_MEMORY_MODEL_DATA canuint8 *ptrData, dataLengthType count);

  extern void     TP_API_CALL_TYPE TpTxResetChannel             (canuint8 tpChannel);
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  extern canuint8 TP_API_CALL_TYPE TpTxGetConnectionStatus      (canuint8 connection);  
# else
#  define TpTxGetConnectionStatus(connection)                   (connection)
# endif

# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  extern void     TP_API_CALL_TYPE TpTxLockChannel              (canuint8 tpChannel);
  extern void     TP_API_CALL_TYPE TpTxUnlockChannel            (canuint8 tpChannel);
  extern canuint8 TP_API_CALL_TYPE TpTxGetFreeChannel           (canuint8 connection);
  extern canuint8 TP_API_CALL_TYPE TpRxGetFreeChannel           (canuint8 connection);
# endif

# if defined (TP_ENABLE_EXTENDED_ADDRESSING)      || \
     defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  || \
     defined (TP_ENABLE_MIXED_29_ADDRESSING)
  extern void     TP_API_CALL_TYPE TpTxSetTargetAddress         (canuint8 tpChannel, canuint8 address);
# endif
...
# if (kTpNumberOfCanChannels > 1)
#  if defined (TP_ENABLE_DYNAMIC_CHANNELS)
  extern canuint8 TP_API_CALL_TYPE TpTxGetCanChannel            (canuint8 tpChannel);
  extern void     TP_API_CALL_TYPE TpTxSetCanChannel            (canuint8 tpChannel, canuint8 canChannel);
#  endif
# endif
#  if defined (TP_ENABLE_DYNAMIC_CHANNELS)
#   if ((defined (TP_ENABLE_NORMAL_ADDRESSING)) || (defined (TP_ENABLE_MIXED_11_ADDRESSING)))
...
#    if (TP_USE_MIXED_IDS_FOR_NORMAL == kTpOn)
  extern void      TP_API_CALL_TYPE TpTxSetChannelExtID          (canuint8 tpChannel, canuint32 transmitID, canuint32 receiveID);
  extern void      TP_API_CALL_TYPE TpTxSetChannelID             (canuint8 tpChannel, canuint16 transmitID, canuint16 receiveID);
  extern void      TP_API_CALL_TYPE TpRxSetTransmitExtID         (canuint8 tpChannel, canuint32 transmitID);
  extern void      TP_API_CALL_TYPE TpRxSetTransmitID            (canuint8 tpChannel, canuint16 transmitID);
#    elif (TP_USE_EXT_IDS_FOR_NORMAL == kTpOn)
  extern void      TP_API_CALL_TYPE TpTxSetChannelExtID          (canuint8 tpChannel, canuint32 transmitID, canuint32 receiveID);
  extern void      TP_API_CALL_TYPE TpRxSetTransmitExtID         (canuint8 tpChannel, canuint32 transmitID);
#    else
...
# if defined(TP_ENABLE_DYNAMIC_CHANNELS) && defined(TP_ENABLE_CANFD)
  extern void     TP_API_CALL_TYPE TpTxSetCanType(canuint8 tpChannel, canuint8 canType);
  extern canuint8 TP_API_CALL_TYPE TpTxGetCanType(canuint8 tpChannel);
  extern canuint8 TP_API_CALL_TYPE TpRxGetCanType(canuint8 tpChannel);
# endif

# if defined (TP_ENABLE_EXTENDED_ADDRESSING)
#  if (TP_USE_MULTIPLE_BASEADDRESS == kTpOn)
  extern void      TP_API_CALL_TYPE TpTxSetBaseAddress          (canuint8 tpChannel, canuint16 baseAddress);
#  endif
# endif
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
#  if (TP_USE_TX_CHANNEL_WITHOUT_FC == kTpOn)
  extern void TP_API_CALL_TYPE TpTxWithFC                       (canuint8 tpChannel);
  extern void TP_API_CALL_TYPE TpTxWithoutFC                    (canuint8 tpChannel);
#  define TpTxSetWithFC                                         TpTxWithFC    
#  define TpTxSetWithoutFC                                      TpTxWithoutFC 
#  endif
# endif
...
# if defined (TP_ENABLE_EXTENDED_ADDRESSING)      || \
     defined (TP_ENABLE_NORMAL_FIXED_ADDRESSING)  || \
     defined (TP_ENABLE_MIXED_29_ADDRESSING)                
  extern canuint8 TP_API_CALL_TYPE TpRxGetSourceAddress         (canuint8 tpChannel);
  extern canuint8 TP_API_CALL_TYPE TpRxGetReceivedTargetAddress (canuint8 tpChannel);
# endif
# if (kTpNumberOfCanChannels > 1)
...
#   if (TP_USE_MIXED_IDS_FOR_NORMAL == kTpOn)
  extern canuint32 TP_API_CALL_TYPE TpRxGetChannelExtID         (canuint8 tpChannel);
  extern canuint16 TP_API_CALL_TYPE TpRxGetChannelID            (canuint8 tpChannel);
  extern canuint8  TP_API_CALL_TYPE TpRxGetChannelIDType        (canuint8 tpChannel);
#   elif (TP_USE_EXT_IDS_FOR_NORMAL == kTpOn)
  extern canuint32 TP_API_CALL_TYPE TpRxGetChannelExtID         (canuint8 tpChannel);
#   else
  extern canuint16 TP_API_CALL_TYPE TpRxGetChannelID            (canuint8 tpChannel);
...
# if defined (TP_ENABLE_EXTENDED_ADDRESSING)
#  if (TP_USE_MULTIPLE_BASEADDRESS == kTpOn)
  extern canuint16 TP_API_CALL_TYPE TpRxGetBaseAddress          (canuint8 tpChannel);
#  endif
# endif
...
# if defined (TP_ENABLE_DYNAMIC_CHANNELS)
#  if (TP_USE_RX_CHANNEL_WITHOUT_FC == kTpOn)
  extern void TP_API_CALL_TYPE TpRxWithFC                       (canuint8 tpChannel);
  extern void TP_API_CALL_TYPE TpRxWithoutFC                    (canuint8 tpChannel);
#  endif
# endif
#endif
...
# if defined (TP_ENABLE_MIXED_29_ADDRESSING)      || \
     defined (TP_ENABLE_MIXED_11_ADDRESSING)
  extern void TP_API_CALL_TYPE TpTxSetAddressExtension(canuint8 tpChannel, canuint8 addressExtension);
# endif
...
# if defined (TP_ENABLE_MIXED_29_ADDRESSING)      || \
     defined (TP_ENABLE_MIXED_11_ADDRESSING)
  extern canuint8 TP_API_CALL_TYPE TpRxGetAddressExtension(canuint8 tpChannel);
# endif
# if defined (TP_TEST_ROUTINE_CONF_TIMEOUT)
...
#if defined (TP_ENABLE_MULTIPLE_ADDRESSING)
# if defined (TP_ENABLE_SINGLE_CHANNEL_TP)
/* extern void TP_API_CALL_TYPE TpTxSetAddressingFormat(canuint8 addressingFormat); */
/* not supported */
# else
  extern void TP_API_CALL_TYPE TpTxSetAddressingFormat(canuint8 tpChannel, SupportInfoStruct supportInfo);
#  define TpTxGetAddressingFormat( tpChannel)    (tpTxInfoStruct[tpChannel].addressingFormat)
#  define TpTxGetAssignedDestination( tpChannel) (tpTxInfoStruct[tpChannel].assignedDestination)
# endif
#endif
...
#if defined (TP_ENABLE_SINGLE_CHANNEL_TP)
# if defined (TP_ENABLE_DYNAMIC_CHANNELS) 
#  define TpTxData()          (TpCanTxDataPtr(0))
# else
#  define TpTxData()          (CanGetTxDataPtr(kTpTxHandle_Field[0]))
# endif                       
#else
# if defined (TP_ENABLE_DYNAMIC_CHANNELS) 
#  define TpTxData(tpChannel)    (TpCanTxDataPtr(tpChannel))
# else
...
# if defined (TP_ENABLE_MULTIPLE_ADDRESSING)
/*******************************************************************************
* NAME:              TpRxGetAddressingFormat, TpRxGetAssignedDestination
*
* CALLED BY:         Application
* PRECONDITIONS:     
*
...
/*  not supported */
#  else
#   define TpRxGetAddressingFormat(tpChannel)     (tpRxInfoStruct[tpChannel].addressingFormat)
#   define TpRxGetAssignedDestination( tpChannel) (tpRxInfoStruct[tpChannel].assignedDestination)
#  endif
# endif
...
#   endif
  ...
  *******************************************************************************/
#    if (TP_USE_GATEWAY_API == kTpOn)    
  typedef TP_MEMORY_MODEL_DATA canuint8 *  TP_API_CALLBACK_TYPE (*ApplTpGetRxBufferFct)(canuint8, dataLengthType, CanRxInfoStructPtr);
#    else
  typedef TP_MEMORY_MODEL_DATA canuint8 *  TP_API_CALLBACK_TYPE (*ApplTpGetRxBufferFct)(canuint8, dataLengthType);
#    endif
  typedef void        TP_API_CALLBACK_TYPE (*ApplTpIndicationFct)(canuint8, dataLengthType);
...
#   endif                                                    
  ...
  V_MEMROM0 extern V_MEMROM1 ApplTpCanMessageTransmittedFct V_MEMROM2 TpRxCanMessageTransmitted[];
...
#  if defined (TP_ENABLE_DYNAMIC_CHANNELS)
#   if defined (TPC_ENABLE_DYN_TX_OBJECTS)
  typedef CanTransmitHandle (*TpCanGetDynTxObjFct)(CanTransmitHandle txObject );
#    if defined (TPC_ENABLE_DYN_TX_ID) 
  typedef void (*TpCanDynTxObjSetIdFct)(CanTransmitHandle txObject, canuint16 id);
#     if defined (C_ENABLE_EXTENDED_ID)
  typedef void (*TpCanDynTxObjSetExtIdFct)(CanTransmitHandle txObject, canuint16 idExtHi, canuint16 idExtLo);
#     endif
#    endif
#    if defined (TPC_ENABLE_DYN_TX_DLC)
  typedef void (*TpCanDynTxObjSetDlcFct)(CanTransmitHandle txObject, canuint8 dlc);
#    endif
#    if defined (TPC_ENABLE_DYN_TX_DATAPTR)
  typedef void  (*TpCanDynTxObjSetDataPtrFct)(CanTransmitHandle txObject, void* pData);
#    endif
#    if defined (TPC_ENABLE_DYN_TX_PRETRANS_FCT)
#     if defined (C_ENABLE_PRETRANSMIT_FCT)
  typedef void (*TpCanDynTxObjSetPreTransmitFct)(CanTransmitHandle txObject, ApplPreTransmitFct pfPTFct);
#     endif
#    endif
#    if defined (TPC_ENABLE_DYN_TX_CONF_FCT)
  typedef void (*TpCanDynTxObjSetConfirmationFct)(CanTransmitHandle txObject, ApplConfirmationFct pfCFct);
#    endif
#   endif
#  endif
# endif
