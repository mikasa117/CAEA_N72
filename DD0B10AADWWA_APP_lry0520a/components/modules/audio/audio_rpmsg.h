...
#define RPMSG_SYNC_FUNC_AUDIO_NS_INIT               RPMSG_SYNC_FUNC_MSG(RPMSG_SYNC_FUNC_TYPE_AUDIO, 0x0014)
#define RPMSG_SYNC_FUNC_AUDIO_NS_EXEC               RPMSG_SYNC_FUNC_MSG(RPMSG_SYNC_FUNC_TYPE_AUDIO, 0x0015)
#define RPMSG_SYNC_FUNC_AUDIO_NS_DESTROY            RPMSG_SYNC_FUNC_MSG(RPMSG_SYNC_FUNC_TYPE_AUDIO, 0x0016)
...
struct rpmsg_sync_msg_audio_ns_init {
    uint32_t sample_rate;
    uint8_t ns_level;
    uint32_t *frame_size;
};

struct rpmsg_sync_msg_audio_ns_exec {
    void *handle;
    const int16_t *mic_in;
    int16_t **out;
};

struct rpmsg_sync_msg_audio_ns_destroy {
    void *handle;
};
