...
#define DSP_SRAM_BASE_ADDR                  0x60000000
#define DSP_SRAM_MCU_BASE_ADDR              0x20000000
...
#define DSP_SRAM_2_MCU_SRAM(x)              ((uint32_t)(x) - DSP_SRAM_BASE_ADDR + DSP_SRAM_MCU_BASE_ADDR)
