...
typedef struct
{
    ...
    uint32_t PSD_DAC_PLL_CLKEN : 1;
    uint32_t PSD_DAC_EXT_CLKEN : 1;
    uint32_t rsv_2             : 22;
}REG_CLK_EN8_t;
...
#define __SYSTEM_AES_CLK_SELECT_SPLL()                  (SYSTEM->ClockSEL1.AES_CLK_SEL = 1)
...
#define __SYSTEM_PSD_DAC_PLL_CLK_ENABLE()                 (SYSTEM->ClockEnable8.PSD_DAC_PLL_CLKEN = 1)
#define __SYSTEM_PSD_DAC_PLL_CLK_DISABLE()                (SYSTEM->ClockEnable8.PSD_DAC_PLL_CLKEN = 0)
#define __SYSTEM_PSD_DAC_EXT_CLK_ENABLE()                 (SYSTEM->ClockEnable8.PSD_DAC_EXT_CLKEN = 1)
#define __SYSTEM_PSD_DAC_EXT_CLK_DISABLE()                (SYSTEM->ClockEnable8.PSD_DAC_EXT_CLKEN = 0)
...
#define __SYSTEM_EFUSE2_CLK_ENABLE()                    (SYSTEM->ClockEnable9.EFUSE2_CLKEN = 1)
...
#define __SYSTEM_EFUSE2_CLK_DISABLE()                   (SYSTEM->ClockEnable9.EFUSE2_CLKEN = 0)
...
#define __SYSTEM_EFUSE2_RESET()                         (SYSTEM->RegReset9.EFUSE2_SFT_RST = 1)
/* ======================================================================================================= */
...
#define __SYSTEM_FR3066EQC_QSPI0_IO2_IO3_CONFIG()                 do { __SYSTEM_QSPI0_PAD4_USED_IO2();   \
                                                                       __SYSTEM_QSPI0_PAD5_USED_IO3();   \
                                                                       __SYSTEM_QSPI0_PAD1_USED_REGIO(); \
                                                                       __SYSTEM_QSPI0_PAD6_USED_REGIO(); \
                                                                       __SYSTEM_QSPI0_PAD8_USED_REGIO(); \
                                                                       __SYSTEM_QSPI0_PAD_PULL_DISABLE(SYSTEM_QSPI0_PAD0|SYSTEM_QSPI0_PAD7|SYSTEM_QSPI0_PAD2|SYSTEM_QSPI0_PAD3|SYSTEM_QSPI0_PAD5|SYSTEM_QSPI0_PAD4); \
                                                                       __SYSTEM_QSPI0_PAD_INPUT_ENABLE(SYSTEM_QSPI0_PAD2|SYSTEM_QSPI0_PAD5|SYSTEM_QSPI0_PAD4); \
                                                                  } while(0)
...
#define __RAM_CODE              __attribute__((section("ram_code." STR(__COUNTER__) STR(__LINE__))))
#endif
#define __RAM_CODE_FRONT        __attribute__((section("ram_code_front")))
...
void system_power_off_post_process(void);
