...
{ 
    ...
    hpipo->eFuse_Length = 0x1C64;

    /* config write mode */
    Efuse_delay(156);
    hpipo->eFuse_Ctrl = EFUSE_PIPO_WRITE_MODE | EFUSE_PIPO_AVDDEN; 
    system_delay_us(4);         
    hpipo->eFuse_Ctrl = EFUSE_PIPO_WRITE_MODE | EFUSE_PIPO_GO | EFUSE_PIPO_AVDDEN;
