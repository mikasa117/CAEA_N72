...
typedef enum
{
    ...
    PSD_DAC_SAMPLE_RATE_RSV,     // 8: reserved
...
#define __PSD_DAC_IS_USB_MODE()                             (PSD_DAC->DACCfg.USB_MODE)
...
#define __PSD_DAC_INT_STATUS_ENABLE(__STATUS__)             (PSD_DAC->DACIntEn |= (__STATUS__))
#define __PSD_DAC_INT_STATUS_DISABLE(__STATUS__)            (PSD_DAC->DACIntEn &= ~(__STATUS__))
