...
#define PMU_REG_POW_SW_CFG_EN0      0x90
#define PMU_REG_POW_SW_CFG_EN1      0x91
...
#define PMU_REG_PLLLDO_CTRL_0       0xe8
...
#define PMU_REG_XTAL_CTRL           0xf5
#define PMU_XTAL_EN_BIT             (1<<7)
#define PMU_XTAL_CAP_POS            4
#define PMU_XTAL_CAP_BIT            (7<<4)
...
typedef enum
{
    PMU_XTAL32K_CAP_7P3,     // 7.3   pf
    PMU_XTAL32K_CAP_8P05,    // 8.05  pf
    PMU_XTAL32K_CAP_8P78,    // 8.78  pf
    PMU_XTAL32K_CAP_9P51,    // 9.51  pf
    PMU_XTAL32K_CAP_10P24,   // 10.24 pf
    PMU_XTAL32K_CAP_10P97,   // 10.97 pf
    PMU_XTAL32K_CAP_11P7,    // 11.7  pf
    PMU_XTAL32K_CAP_12P43,   // 12.43 pf
}enum_PMU_XTAL32K_CAP_t;

typedef enum 
{
    PMU_CLK_SEL_RCLP_DIV2,        // internal RC clock
    PMU_CLK_SEL_XTAL32768,        // external low speed xtal
}enum_PMU_clock_sel_t;
