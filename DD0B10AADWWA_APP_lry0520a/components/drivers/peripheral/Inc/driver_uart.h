...
#define __UART_IS_BUSY(__UARTx__)                      (__UARTx__->USR.BUSY == 1)
...
#define __UART_IS_DLL_DLH_ACCESS(__UARTx__)            (__UARTx__->LCR.Bits.DLAB)
...
/* uart_transmit_IT_stop */
/* uart_receive_IT_stop */
