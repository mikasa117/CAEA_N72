...
/* SPI RX Flow Size set */
#define __SPI_SET_FLOW_SIZE(__SPIx__, __SIZE__)              (__SPIx__->FLOW_CTRL.RX_FLOW_LR = __SIZE__)

/* SPI RX Flow Enable and Disable */
#define __SPI_FLOW_ENABLE(__SPIx__)                          (__SPIx__->FLOW_CTRL.RX_FLOW_EN = 1)
#define __SPI_FLOW_DISABLE(__SPIx__)                         (__SPIx__->FLOW_CTRL.RX_FLOW_EN = 0)
