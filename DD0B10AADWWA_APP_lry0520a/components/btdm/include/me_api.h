 ...
 */
typedef uint16_t BtEscoPktType;
 ...
 */
typedef uint8_t CmgrAudioParms;
 ...
 *
 *     This function set voice codec type.  
 *
 * Parameters:
 * 
 *     setting. 0x60--cvsd,0x63--cvsd&msbc  
 *
 * Returns:
 *
 *     NULL
 ...
 *     setting. 0x60--cvsd,0x63--cvsd&msbc
 */
extern BtScoAudioSettings CMGR_GetAudioVoiceSettings(void);
 ...
 */
extern BtStatus CMGR_SetAudioCustomParms(BtScoTxParms *customParms);
 ...
 *     void
 */
extern void CMGR_SetAudioDefaultParms(CmgrAudioParms Parms);
 ...
 *
 *     BT_STATUS_PENDING - Maybe in cancel link state, wait cancel cmd complete.
 *
 *     (Also see ME_DisconnectLink)
 */
extern BtStatus CMGR_RemoveDataLink(CmgrHandler *Handler);
#endif /* __ME_H */
