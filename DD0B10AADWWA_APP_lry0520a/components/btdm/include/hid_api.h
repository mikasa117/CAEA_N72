...
/** A hid control connection is open. , the "ptrs.remDev" field 
 *  contains a pointer to the remote device.
 */
#define HIDEVENT_CTRL_CHAN_OPEN          11

/** A hid interrupt connection is open. , the "ptrs.remDev" field 
 *  contains a pointer to the remote device.
 */
#define HIDEVENT_INTR_CHAN_OPEN          12
 ...
 *         lower layer service in use (L2CAP or Management Entity).
 */
BtStatus HID_RegisterHost(HidChannel *Channel, HidCallback Callback);
#define HID_RegisterHost(ch, cb)  HID_Register(ch, cb, HID_ROLE_HOST, 0, NULL)
 ...
 *         lower layer service in use (L2CAP or Management Entity).
 */
BtStatus HID_RegisterHostSec(HidChannel *Channel, HidCallback Callback, BtSecurityParms *secParms);
#define HID_RegisterHostSec(ch, cb, sec) HID_Register(ch, cb, HID_ROLE_HOST, sec, NULL)
